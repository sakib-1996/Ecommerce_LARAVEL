...
@section('admin_contant')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Delivaried Products</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark">
                            <h3 class="card-title">All Delivaried Products List Here</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table style="width: 100%" id=""
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%">Delivared Date</th>
                                    ...
                                    @isset($invoices)
                                        @foreach ($invoices as $invoice)
                                            <tr>
                                                ...
                                                <td><span
                                                        class="badge badge-success ml-1">{{ $invoice->delivery_status }}</span>
                                                </td>
                                                <td>
