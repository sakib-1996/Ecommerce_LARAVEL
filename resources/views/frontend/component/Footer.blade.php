            ...
            <div class="row reveal">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget">
                        <div class="footer_logo">
                            <a href="{{ route('home') }}"><img src="{{ asset('frontend') }}/assets/images/logo_light.png" alt="logo"/></a>
                        </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="widget">
                        ...
                        <ul class="widget_links">
                            ...
                            <li><a href="{{ route('contactPage') }}">Complain</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-6">
                ...
                <div class="col-lg-2 col-md-6 col-sm-6">
                    <div class="widget">
                        ...
                        <ul class="widget_links">
                            <li><a href="{{ route('userDashboard') }}">Profile</a></li>
                            <li><a href="{{ route('wishlist') }}">Wish List</a></li>
                            <li><a href="{{ route('viewCart') }}">Cart List</a></li>
